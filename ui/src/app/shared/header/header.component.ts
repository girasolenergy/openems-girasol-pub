...
export class HeaderComponent implements OnInit, OnDestroy, AfterViewChecked {
    ...
    public currentPage: 'EdgeSettings' | 'Other' | 'IndexLive' | 'IndexHistory' | 'IndexMeter' = 'Other';
    ...
    ngOnInit() {
       // set inital URL
        ...
        this.translateService.get('General.meter').subscribe((translation: string) => {
    ...
    updateCurrentPage(url: string) {
        ...
        if ((file == 'history' || file == 'live' || file == 'meters') && urlArray.length == 3) {
            if (file == 'history') {
