...
@NgModule({
  imports: [
    ...
    FormlyModule.forRoot({
      wrappers: [
        ...
        {
          name: 'formly-field-radio-with-image',
          component: FormlyFieldRadioWithImageComponent,
        },
        {
  ...
  //providers：该数组列出了该应用所使用可注入装饰器修饰的服务，当直接把服务列在这里时，他们是全应用范围的。在使用特性模块和惰性加载时，可以用范围约束他们。
  providers: [appRoutingProviders, Service, Utils, Websocket, Logger],
})
