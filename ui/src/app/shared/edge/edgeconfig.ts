...
export class EdgeConfig {
    ...
    public isProducer(component: EdgeConfig.Component) {
        ...
        switch (component.factoryId) {
            ...
            case 'PV-Inverter.HUAWEI.SMARTLOGGER':
            case 'PVInverter.HUAWEI.SMARTLOGGER':
            case 'PV-Inverter.SMA.SUNNYBOY.Girasol':
            case 'PVInverter.SMA.SUNNYBOY.Girasol':
                return true;
        }
    ...
    public listAvailableFactories(): CategorizedFactories[] {
        let allFactories = [
            ...
            {
                category: { title: 'Counter', icon: 'speedometer-outline' },
                factories: [
            ...
            {
                category: { title: 'Electric Vehicle Charging Station', icon: 'car-outline' },
                factories: [
                    this.getFactoriesByNature("io.openems.edge.evcs.api.Evcs"),
                ],
            },
            {
                category: { title: ' Electric Vehicle Charging Station Control', icon: 'options-outline' },
                factories: [
            ...
            {
                category: { title: 'Additional', icon: 'radio-button-off-outline' },
