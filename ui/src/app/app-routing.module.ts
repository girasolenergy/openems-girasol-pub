...
const routes: Routes = [
  ...
  //{ path: 'device/:edgeId/meters', component: EdgeMeterComponent },
  //惰性加载EdgeMeterComponent import {LazyComponent} from './lazy.component';
  //export const lazyRoutes: Routes = [{path: '', component: LazyComponent}];
  //{path: 'device/:edgeId/meters', loadChildren:()=>import('./edge/meters/meters.routes').then(routes => routes.lazyRoutes)},
  {
    path: 'device/:edgeId',
...
@NgModule({
  //　imports:导入模块以获取模块中定义的各种服务
  imports: [
    RouterModule.forRoot(routes, { preloadingStrategy: PreloadAllModules }),
  ],
  //exports：那些能在其他模块的组件模板中使用的可声明对象的子集
