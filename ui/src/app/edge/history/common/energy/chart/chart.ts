...
import {
  ...
  HistoryUtils,
  YAxisTitle,
} from 'src/app/shared/service/utils';
import { ChannelAddress, EdgeConfig, Utils } from 'src/app/shared/shared';

@Component({
  selector: 'energychart',
  templateUrl:
    '../../../../../shared/genericComponents/chart/abstracthistorychart.html',
})
export class ChartComponent extends AbstractHistoryChart {
  ...
  public static getChartData(
    ...
    let input: HistoryUtils.InputChannel[] = config?.widgets.classes.reduce(
            ...
            chartType === 'bar' && {
              ...
              converter: () =>
                data['ProductionActivePower']
                  ...
                  ?.map((value) =>
                    HistoryUtils.ValueConverter.NEGATIVE_AS_ZERO(value)
                  ),
              ...
              converter: () => {
                const essSoc = data['EssSoc']?.map((value, index, arr) => {
                  if (value === null) {
                    ...
                    return nonNullValue !== null ? nonNullValue * 1000 : null;
                  } else {
                    return value * 1000;
                  }
                });
                // const essSoc = data['EssSoc']?.map((value) =>
