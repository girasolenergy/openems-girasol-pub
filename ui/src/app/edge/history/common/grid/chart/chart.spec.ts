      ...
      expectView(defaultEMS, TEST_CONTEXT, 'bar', History.MONTH,
        {
          datasets: {
            data: [
              DATA('売電: 12,738 kWh', [603, 590, 551, 572, 69, 236, 626, null, 1003, 261, 518, 698, 640, 388, 471, 373, 373, 677, 286, 406, 249, null, 446, 369, 558, null, 776, 425, 574, null]),
              DATA('買電: 773 kWh', [16, 6, 3, 3, 5, 48, 4, null, 5, 26, 17, 62, 8, 66, 13, 21, 4, 3, 18, 27, 29, null, 118, 85, 2, null, 72, 28, 84, null]),
            ],
      ...
      expectView(defaultEMS, TEST_CONTEXT, 'bar', History.YEAR,
        {
          datasets: {
            data: [
              DATA('売電: 30,703 kWh', [20, 86, 677, 3657, 12839, 12738, 627, null, null, null, null, null]),
              DATA('買電: 23,209 kWh', [9829, 4812, 2915, 2036, 2712, 773, 94, null, null, null, null, null]),
            ],
