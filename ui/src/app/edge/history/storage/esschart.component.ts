...
export class StorageESSChartComponent
                  ...
                  (channelAddresses) => {
                    channelAddresses.forEach((channelAddress) => {
                      ...
                      if (!data) {
                        ...
                        if (
                          this.componentId + '/ActivePowerL1' &&
                          this.componentId + '/ActivePowerL2' &&
                          this.componentId + '/ActivePowerL3' in result.data &&
