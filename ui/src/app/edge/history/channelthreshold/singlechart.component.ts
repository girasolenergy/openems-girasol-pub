...
export class ChannelthresholdSingleChartComponent
  ...
  implements OnInit, OnChanges, OnDestroy
{
  ...
  protected setLabel() {
    ...
    options.scales.yAxes[0].scaleLabel.labelString =
      this.translate.instant('General.percentage');
    options.tooltips.callbacks.label = function (
      ...
      return label + ': ' + formatNumber(value, 'en', '1.0-0') + ' %'; // TODO get locale dynamically
    };
