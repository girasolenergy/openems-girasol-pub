...
export abstract class AbstractHistoryChart {
  ...
  //observable is used to fetch new chart data every 1 minutes
   ...
   */
  protected abstract getChannelAddresses(
    edge: Edge,
    config: EdgeConfig
            ...
            this.getChannelAddresses(edge, config).then((channelAddresses) => {
              ...
              edge
                ...
                .catch((error) => {
                  ...
                  resolve(
                    new QueryHistoricTimeseriesDataResponse(error.id, {
                      timestamps: [null],
                      data: { null: null },
                    })
                  );
  ...
  protected queryHistoricTimeseriesEnergyPerPeriod(
    ...
    let response: Promise<QueryHistoricTimeseriesEnergyPerPeriodResponse> =
            ...
            this.service.getConfig().then((config) => {
              edge
                ...
                .catch((response) => {
                  ...
                  resolve(
                    new QueryHistoricTimeseriesDataResponse('0', {
                      timestamps: [null],
                      data: { null: null },
                    })
                  );
