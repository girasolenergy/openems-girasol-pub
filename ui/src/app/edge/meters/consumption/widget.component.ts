  ...
  implements OnInit, OnChanges, OnDestroy
{
  ...
  constructor(public override service: Service, private route: ActivatedRoute) {
    super(service);
  }
        ...
        this.service
          ...
          .then((response) => {
            ...
            this.evcsComponents.forEach((component) => {
              otherEnergy +=
                this.data[component.id + '/ActiveConsumptionEnergy'] ?? 0;
            });

            this.consumptionMeterComponents.forEach((component) => {
              otherEnergy +=
                this.data[component.id + '/ActiveProductionEnergy'] ?? 0;
            });
            this.totalOtherEnergy =
  ...
  protected getChannelAddresses(
    ...
    return new Promise((resolve) => {
      ...
      this.consumptionMeterComponents = config
