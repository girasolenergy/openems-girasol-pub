...
export class Evcs_Api_ClusterComponent extends AbstractFlatWidget {
  ...
  protected override getChannelAddresses() {
    this.evcsIdsInCluster =
      this.config.components[this.componentId].properties['evcs.ids'];
  ...
  protected override onCurrentData(currentData: CurrentData) {
    ...
    this.isConnectionSuccessful =
      currentData.allComponents[this.componentId + '/State'] != 3
        ? true
        : false;
