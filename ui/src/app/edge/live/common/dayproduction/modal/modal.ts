...
import {Edge, EdgeConfig, Utils,Service } from 'src/app/shared/shared';


@Component({
  selector: ProductionDayOverviewComponent.SELECTOR,
    templateUrl: './modal.html',
})
export class ProductionDayOverviewComponent implements OnInit {

  private static readonly SELECTOR = "production-day-overview";
