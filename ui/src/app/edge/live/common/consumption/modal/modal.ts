...
import {
  AbstractFormlyComponent,
  OeFormlyField,
  OeFormlyView,
} from 'src/app/shared/genericComponents/shared/oe-formly-component';
...
export class ModalComponent extends AbstractFormlyComponent {
  protected override generateView(
    config: EdgeConfig,
    role: Role
  ): OeFormlyView {
  ...
  public static generateView(
    ...
    // OtherPower
    let channelsToSubscribe: ChannelAddress[] = [
      new ChannelAddress('_sum', 'ConsumptionActivePower'),
    ];

    evcss.forEach((evcs) =>
      channelsToSubscribe.push(new ChannelAddress(evcs.id, 'ChargePower'))
    );
