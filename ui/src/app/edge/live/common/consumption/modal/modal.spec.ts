import {
  ...
  LINE_HORIZONTAL,
  LINE_INFO_PHASES_DE,
  SOCOMEC_CONSUMPTION_METER,
  VALUE_FROM_CHANNELS_LINE,
  ...
  it('generateView()', () => {
    // No evcs and consumptionMeters and negative ConsumptionActivePower
    {
      ...
      expectView(EMS, Role.ADMIN, VIEW_CONTEXT, TEST_CONTEXT, {
        ...
        lines: [
          CHANNEL_LINE('合計', '0 W'),
          CHANNEL_LINE('フェーズ L1', '0 W', TextIndentation.SINGLE),
          CHANNEL_LINE('フェーズ L2', '1.000 W', TextIndentation.SINGLE),
          CHANNEL_LINE('フェーズ L3', '0 W', TextIndentation.SINGLE),
          LINE_HORIZONTAL,
          VALUE_FROM_CHANNELS_LINE('その他の消費', '0 W'),
          LINE_INFO_PHASES_DE,
        ],
      });
    }
    ...
    // two evcs and two consumptionMeter, negative consumptionMeter phase
    {
      ...
      expectView(EMS, Role.ADMIN, VIEW_CONTEXT, TEST_CONTEXT, {
        title: '消費',
        lines: [
          CHANNEL_LINE('合計', '1.000 W'),
          CHANNEL_LINE('フェーズ L1', '300 W', TextIndentation.SINGLE),
          CHANNEL_LINE('フェーズ L2', '350 W', TextIndentation.SINGLE),
          CHANNEL_LINE('フェーズ L3', '350 W', TextIndentation.SINGLE),
          LINE_HORIZONTAL,
    ...
    {
      const EMS = DummyConfig.from(EVCS_KEBA_KECONTACT('evcs0', 'Evcs'));
      const VIEW_CONTEXT: OeFormlyViewTester.Context = {
        '_sum/ConsumptionActivePower': 1000,
        '_sum/ConsumptionActivePowerL1': 300,
        '_sum/ConsumptionActivePowerL2': 350,
